-- =========================================================
-- ACA PLATFORM — DEMO SEED DATA (FIXED SYNTAX)
-- =========================================================
...
values
  ('11111111-1111-1111-1111-111111111111', $$ACA Monthly Blitz Championship$$, $$Fast-paced 5+0 blitz tournament open to all academy students. Climb the leaderboard and earn rating points!$$, 'Swiss 7 Rounds', 'Open', now() + interval '3 days', now()),
  ('22222222-2222-2222-2222-222222222222', $$African Junior Rapid Qualifier$$, $$Official qualification tournament for youth players across Africa. Top 8 advance to finals.$$, 'Rapid 10+5', 'Upcoming', now() + interval '10 days', now())
...
values
  ('33333333-3333-3333-3333-333333333333', $$Grandmaster Opening Preparation Masterclass$$, 'Live Webinar', $$Live interactive webinar with ACA Grandmaster coaches covering modern opening choices and pawn structures.$$, now() + interval '5 days', now()),
  ('44444444-4444-4444-4444-444444444444', $$Middlegame Calculation & Decision Making Clinic$$, 'Interactive Workshop', $$Practical workshop focusing on candidate moves, visualization, and time management in critical positions.$$, now() + interval '12 days', now())
